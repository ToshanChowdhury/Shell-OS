...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        next_btn = QAction(QIcon("cil-arrow-circle-right.png"), "Forward", self)
        ...
        self.httpsicon.setPixmap(QPixmap('cil-lock-unlocked.png'))
        ...
        stop_btn = QAction((QIcon("cil-media-stop.png")), "Stop", self)
        ...
        new_tab_action = QAction(QIcon("cil-newtab.jpg"), "New Tab", self)
        ...
        navigate_home_action = QAction(QIcon(os.path.join('icons', 'cil-exit-to-app.png')),
                                            "Homepage", self)
        navigate_home_action.setStatusTip("Go to Google Homepage")
    ...
    def update_urlbar(self, q, browser=None):
        ...
        if q.scheme() == 'https':
            ...
            self.httpsicon.setPixmap(QPixmap('cil-lock-locked.png'))
